...
const define = (sequelize) => {
  ...
  Article.hasMany(Comment, {as: Alias.COMMENTS, foreignKey: `articleId`, onDelete: `cascade`, hooks: true});
  Comment.belongsTo(Article, {foreignKey: `articleId`, onDelete: `cascade`, hooks: true});
